...
import static javax.swing.WindowConstants.EXIT_ON_CLOSE;
    ...
    public class ADMIN_ManageProfile extends JFrame {
        ...
        private void initUI() {
            ...
            backButton = new JButton("Back to Admin Main Page");
        ...
        public static void main(String[] args) {
            SwingUtilities.invokeLater(() -> {
                ADMIN_ManageProfile manageProfilePage = new ADMIN_ManageProfile();
